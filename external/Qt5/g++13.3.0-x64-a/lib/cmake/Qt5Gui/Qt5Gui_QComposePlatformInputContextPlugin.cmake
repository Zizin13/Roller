...
set(_Qt5QComposePlatformInputContextPlugin_MODULE_DEPENDENCIES "Gui;Gui;Core;Core")

foreach(_module_dep ${_Qt5QComposePlatformInputContextPlugin_MODULE_DEPENDENCIES})
...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/platforminputcontexts/libcomposeplatforminputcontextplugin.prl" RELEASE
    _Qt5QComposePlatformInputContextPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QComposePlatformInputContextPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QComposePlatformInputContextPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Gui_QComposePlatformInputContextPlugin_Import.cpp"
)

_populate_Gui_plugin_properties(QComposePlatformInputContextPlugin RELEASE "platforminputcontexts/libcomposeplatforminputcontextplugin.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QComposePlatformInputContextPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QComposePlatformInputContextPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QComposePlatformInputContextPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QComposePlatformInputContextPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QComposePlatformInputContextPlugin,${_no_plugins_genex}>>"
        ">"
...
set_property(TARGET Qt5::QComposePlatformInputContextPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
