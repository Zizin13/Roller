...
set(Qt5Qml_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/QtQml/5.15.16"
        "${_qt5Qml_install_prefix}/include/QtQml/5.15.16/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Qml_process_prl_file(
            "${_qt5Qml_install_prefix}/lib/libQt5Qml.prl" RELEASE
    ...
    _populate_Qml_target_properties(RELEASE "libQt5Qml.a" "" FALSE)
