...
set(_Qt5AssimpImporterPlugin_MODULE_DEPENDENCIES "Quick3DAssetImport;Gui;Core")

foreach(_module_dep ${_Qt5AssimpImporterPlugin_MODULE_DEPENDENCIES})
    if(NOT Qt5${_module_dep}_FOUND)
        find_package(Qt5${_module_dep}
            1.0.0 ${_Qt5Quick3DAssetImport_FIND_VERSION_EXACT}
...
_qt5_Quick3DAssetImport_process_prl_file(
    "${_qt5Quick3DAssetImport_install_prefix}/plugins/assetimporters/libassimp.prl" RELEASE
    _Qt5AssimpImporterPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5AssimpImporterPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::AssimpImporterPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Quick3DAssetImport_AssimpImporterPlugin_Import.cpp"
)

_populate_Quick3DAssetImport_plugin_properties(AssimpImporterPlugin RELEASE "assetimporters/libassimp.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::AssimpImporterPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::AssimpImporterPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::AssimpImporterPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::AssimpImporterPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::AssimpImporterPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::AssimpImporterPlugin>"
)
set_property(TARGET Qt5::Quick3DAssetImport APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ${_plugin_genex}
)
set_property(TARGET Qt5::AssimpImporterPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
