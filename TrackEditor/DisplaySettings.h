...
#define SHOW_OWALLFLOOR_SURF_MODEL 0x00004000
#define SHOW_OWALLFLOOR_WIRE_MODEL 0x00008000
#define SHOW_LLOWALL_SURF_MODEL    0x00010000
#define SHOW_LLOWALL_WIRE_MODEL    0x00020000
#define SHOW_RLOWALL_SURF_MODEL    0x00040000
#define SHOW_RLOWALL_WIRE_MODEL    0x00080000
#define SHOW_LUOWALL_SURF_MODEL    0x00100000
#define SHOW_LUOWALL_WIRE_MODEL    0x00200000
#define SHOW_RUOWALL_SURF_MODEL    0x00400000
#define SHOW_RUOWALL_WIRE_MODEL    0x00800000
#define SHOW_SELECTION_HIGHLIGHT   0x01000000
#define SHOW_AILINE_MODELS         0x02000000
#define SHOW_ENVIRONMENT           0x04000000
#define SHOW_TEST_CAR              0x08000000
