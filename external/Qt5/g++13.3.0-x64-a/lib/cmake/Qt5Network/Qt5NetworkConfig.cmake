...
set(Qt5Network_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.15.16"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.15.16/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES dtls;gssapi;opensslv11;ocsp;schannel;sctp;securetransport;ssl;sspi)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 networkinterface;bearermanagement;dnslookup;ftp;http;localserver;networkdiskcache;networkproxy;socks5;udpsocket)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 dtls;gssapi;opensslv11;ocsp;schannel;sctp;securetransport;ssl;sspi)
    set_property(TARGET Qt5::Network
