...
{
  for (int i = iStartIndex; i <= iEndIndex; ++i) {
    m_chunkAy[i].unLeftShoulderWidth = sLeftShoulderWidth.toUShort();
    m_chunkAy[i].unLeftLaneWidth = sLeftLaneWidth.toUShort();
    m_chunkAy[i].unRightLaneWidth = sRightLaneWidth.toUShort();
    m_chunkAy[i].unRightShoulderWidth = sRightShoulderWidth.toUShort();
    m_chunkAy[i].llUnk1 = sUnk1.toLongLong();
    m_chunkAy[i].llUnk2 = sUnk2.toLongLong();
    m_chunkAy[i].llUnk3 = sUnk3.toLongLong();
    m_chunkAy[i].fYaw = sYaw.toFloat();
    m_chunkAy[i].fPitch = sPitch.toFloat();
    m_chunkAy[i].fRoll = sRoll.toFloat();
    m_chunkAy[i].iAILine1 = sAILine1.toInt();
    m_chunkAy[i].iAILine2 = sAILine2.toInt();
    m_chunkAy[i].iAILine3 = sAILine3.toInt();
    m_chunkAy[i].iAILine4 = sAILine4.toInt();
    m_chunkAy[i].unTrackGrip = sTrackGrip.toUShort();
    m_chunkAy[i].unLeftShoulderGrip = sLeftShoulderGrip.toUShort();
    m_chunkAy[i].unRightShoulderGrip = sRightShoulderGrip.toUShort();
    m_chunkAy[i].llUnk4 = sUnk4.toLongLong();
    m_chunkAy[i].llUnk5 = sUnk5.toLongLong();
    m_chunkAy[i].llUnk6 = sUnk6.toLongLong();
    m_chunkAy[i].llUnk7 = sUnk7.toLongLong();
    m_chunkAy[i].llUnk8 = sUnk8.toLongLong();
    m_chunkAy[i].ulLeftSurfaceType = sLeftSurfaceType.toULong();
    m_chunkAy[i].ulCenterSurfaceType = sCenterSurfaceType.toULong();
    m_chunkAy[i].ulRightSurfaceType = sRightSurfaceType.toULong();
    m_chunkAy[i].llUnk9 = sUnk9.toLongLong();
    m_chunkAy[i].llUnk10 = sUnk10.toLongLong();
    m_chunkAy[i].llUnk11 = sUnk11.toLongLong();
    m_chunkAy[i].llUnk12 = sUnk12.toLongLong();
    m_chunkAy[i].llUnk13 = sUnk13.toLongLong();
    m_chunkAy[i].llUnk14 = sUnk14.toLongLong();
    m_chunkAy[i].llUnk15 = sUnk15.toLongLong();
    m_chunkAy[i].llUnk16 = sUnk16.toLongLong();
    m_chunkAy[i].llUnk17 = sUnk17.toLongLong();
    m_chunkAy[i].llUnk18 = sUnk18.toLongLong();
    m_chunkAy[i].llUnk19 = sUnk19.toLongLong();
    m_chunkAy[i].llUnk20 = sUnk20.toLongLong();
    m_chunkAy[i].fUnk1 = sfUnk1.toFloat();
    m_chunkAy[i].fUnk2 = sfUnk2.toFloat();
    m_chunkAy[i].fUnk3 = sfUnk3.toFloat();
    m_chunkAy[i].llUnk21 = sUnk21.toLongLong();
    m_chunkAy[i].llUnk22 = sUnk22.toLongLong();
    m_chunkAy[i].llUnk23 = sUnk23.toLongLong();
    m_chunkAy[i].llUnk24 = sUnk24.toLongLong();
    m_chunkAy[i].llUnk25 = sUnk25.toLongLong();
    m_chunkAy[i].llUnk26 = sUnk26.toLongLong();
    m_chunkAy[i].llUnk27 = sUnk27.toLongLong();
    m_chunkAy[i].llUnk28 = sUnk28.toLongLong();
    m_chunkAy[i].llUnk29 = sUnk29.toLongLong();
    m_chunkAy[i].llUnk30 = sUnk30.toLongLong();
    m_chunkAy[i].llUnk31 = sUnk31.toLongLong();
    m_chunkAy[i].llUnk32 = sUnk32.toLongLong();
    m_chunkAy[i].llUnk33 = sUnk33.toLongLong();
    m_chunkAy[i].llUnk34 = sUnk34.toLongLong();
    m_chunkAy[i].llUnk35 = sUnk35.toLongLong();
    m_chunkAy[i].llUnk36 = sUnk36.toLongLong();
    m_chunkAy[i].llUnk37 = sUnk37.toLongLong();
    m_chunkAy[i].llUnk38 = sUnk38.toLongLong();
    m_chunkAy[i].llUnk39 = sUnk39.toLongLong();
    m_chunkAy[i].llUnk40 = sUnk40.toLongLong();
    m_chunkAy[i].llUnk41 = sUnk41.toLongLong();
    m_chunkAy[i].llUnk42 = sUnk42.toLongLong();
    m_chunkAy[i].llUnk43 = sUnk43.toLongLong();
    m_chunkAy[i].llUnk44 = sUnk44.toLongLong();
    m_chunkAy[i].llUnk45 = sUnk45.toLongLong();
    m_chunkAy[i].llUnk46 = sUnk46.toLongLong();
    m_chunkAy[i].llUnk47 = sUnk47.toLongLong();
    m_chunkAy[i].llUnk48 = sUnk48.toLongLong();
    m_chunkAy[i].llUnk49 = sUnk49.toLongLong();
    m_chunkAy[i].llUnk50 = sUnk50.toLongLong();
  }
  UpdateChunkStrings();
