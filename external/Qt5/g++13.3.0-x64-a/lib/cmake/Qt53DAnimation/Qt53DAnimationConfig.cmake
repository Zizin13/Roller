...
set(Qt53DAnimation_VERSION_STRING 5.15.16)
...
macro(_populate_3DAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt53DAnimation_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::3DAnimation APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.15.16"
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.15.16/Qt3DAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt53DAnimation_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_3DAnimation_process_prl_file(
            "${_qt53DAnimation_install_prefix}/lib/libQt53DAnimation.prl" RELEASE
            _Qt53DAnimation_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt53DAnimation_STATIC_RELEASE_LINK_FLAGS
        )
    endif()

    add_library(Qt5::3DAnimation STATIC IMPORTED)
    set_property(TARGET Qt5::3DAnimation PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_3DAnimation_target_properties(RELEASE "libQt53DAnimation.a" "" FALSE)
