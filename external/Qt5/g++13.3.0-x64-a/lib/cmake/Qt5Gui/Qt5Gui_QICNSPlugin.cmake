...
set(_Qt5QICNSPlugin_MODULE_DEPENDENCIES "Gui;Core")

foreach(_module_dep ${_Qt5QICNSPlugin_MODULE_DEPENDENCIES})
...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/imageformats/libqicns.prl" RELEASE
    _Qt5QICNSPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QICNSPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QICNSPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Gui_QICNSPlugin_Import.cpp"
)

_populate_Gui_plugin_properties(QICNSPlugin RELEASE "imageformats/libqicns.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QICNSPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QICNSPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QICNSPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QICNSPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QICNSPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QICNSPlugin>"
)
...
set_property(TARGET Qt5::QICNSPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Gui;Qt5::Core"
)
