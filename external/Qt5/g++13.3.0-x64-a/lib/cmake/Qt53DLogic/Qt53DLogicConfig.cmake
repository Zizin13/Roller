...
set(Qt53DLogic_VERSION_STRING 5.15.16)
...
function(_qt5_3DLogic_process_prl_file prl_file_location Configuration lib_deps link_flags)
    set(_lib_deps)
    set(_link_flags)

    set(_qt5_install_libs "${_qt53DLogic_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt53DLogic_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt53DLogic_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
                    mark_as_advanced(_Qt53DLogic_${Configuration}_${_lib}_PATH)
                    if(_Qt53DLogic_${Configuration}_${_lib}_PATH)
                        list(APPEND _lib_deps
                            ${_Qt53DLogic_${Configuration}_${_lib}_PATH}
                        )
                    else()
...
macro(_populate_3DLogic_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_deps
        ${_Qt53DLogic_STATIC_${Configuration}_LIB_DEPENDENCIES}
    )
    ...
    set(_static_link_flags "${_Qt53DLogic_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::3DLogic APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::3DLogic)
    ...
    set(Qt53DLogic_PRIVATE_INCLUDE_DIRS
        "${_qt53DLogic_install_prefix}/include/Qt3DLogic/5.15.16"
        "${_qt53DLogic_install_prefix}/include/Qt3DLogic/5.15.16/Qt3DLogic"
    )
    ...
    foreach(_module_dep ${_Qt53DLogic_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt53DLogic_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_3DLogic_process_prl_file(
            "${_qt53DLogic_install_prefix}/lib/libQt53DLogic.prl" RELEASE
            _Qt53DLogic_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt53DLogic_STATIC_RELEASE_LINK_FLAGS
        )
    endif()

    add_library(Qt5::3DLogic STATIC IMPORTED)
    set_property(TARGET Qt5::3DLogic PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_3DLogic_target_properties(RELEASE "libQt53DLogic.a" "" FALSE)
