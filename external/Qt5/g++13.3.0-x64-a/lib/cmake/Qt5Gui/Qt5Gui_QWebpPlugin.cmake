...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/imageformats/libqwebp.prl" RELEASE
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QWebpPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<NOT:$<IN_LIST:Qt::QWebpPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QWebpPlugin>"
)
