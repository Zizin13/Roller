...
set(Qt53DQuickScene2D_VERSION_STRING 5.15.16)
...
function(_qt5_3DQuickScene2D_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt53DQuickScene2D_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt53DQuickScene2D_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt53DQuickScene2D_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
macro(_populate_3DQuickScene2D_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt53DQuickScene2D_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::3DQuickScene2D APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::3DQuickScene2D)
    ...
    set(Qt53DQuickScene2D_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickScene2D_install_prefix}/include/Qt3DQuickScene2D/5.15.16"
        "${_qt53DQuickScene2D_install_prefix}/include/Qt3DQuickScene2D/5.15.16/Qt3DQuickScene2D"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickScene2D_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt53DQuickScene2D_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_3DQuickScene2D_process_prl_file(
            "${_qt53DQuickScene2D_install_prefix}/lib/libQt53DQuickScene2D.prl" RELEASE
    ...
    _populate_3DQuickScene2D_target_properties(RELEASE "libQt53DQuickScene2D.a" "" FALSE)
