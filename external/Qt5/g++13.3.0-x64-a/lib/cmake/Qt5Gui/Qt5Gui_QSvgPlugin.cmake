...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QSvgPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QSvgPlugin,QT_PLUGIN_EXTENDS>,Qt::Svg>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QSvgPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QSvgPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QSvgPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QSvgPlugin>"
)
