...
set(_Qt5QLocalClientConnectionFactory_MODULE_DEPENDENCIES "Qml")

foreach(_module_dep ${_Qt5QLocalClientConnectionFactory_MODULE_DEPENDENCIES})
...
_qt5_Qml_process_prl_file(
    "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_local.prl" RELEASE
    _Qt5QLocalClientConnectionFactory_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QLocalClientConnectionFactory_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QLocalClientConnectionFactory PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Qml_QLocalClientConnectionFactory_Import.cpp"
)

_populate_Qml_plugin_properties(QLocalClientConnectionFactory RELEASE "qmltooling/libqmldbg_local.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QLocalClientConnectionFactory,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QLocalClientConnectionFactory,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QLocalClientConnectionFactory,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QLocalClientConnectionFactory,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QLocalClientConnectionFactory,${_no_plugins_genex}>>"
        ">"
...
set_property(TARGET Qt5::QLocalClientConnectionFactory APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Qml"
)
