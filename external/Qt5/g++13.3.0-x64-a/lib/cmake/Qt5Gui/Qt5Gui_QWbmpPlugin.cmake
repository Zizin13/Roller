...
set(_Qt5QWbmpPlugin_MODULE_DEPENDENCIES "Gui;Core")

foreach(_module_dep ${_Qt5QWbmpPlugin_MODULE_DEPENDENCIES})
...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/imageformats/libqwbmp.prl" RELEASE
    _Qt5QWbmpPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QWbmpPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QWbmpPlugin PROPERTY INTERFACE_SOURCES
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QWbmpPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QWbmpPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QWbmpPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QWbmpPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QWbmpPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QWbmpPlugin>"
)
...
set_property(TARGET Qt5::QWbmpPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Gui;Qt5::Core"
)
