...
set(_Qt5QXcbIntegrationPlugin_MODULE_DEPENDENCIES "XcbQpa;Gui;Gui;Core;Core")

foreach(_module_dep ${_Qt5QXcbIntegrationPlugin_MODULE_DEPENDENCIES})
...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/platforms/libqxcb.prl" RELEASE
    _Qt5QXcbIntegrationPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QXcbIntegrationPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QXcbIntegrationPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Gui_QXcbIntegrationPlugin_Import.cpp"
)

_populate_Gui_plugin_properties(QXcbIntegrationPlugin RELEASE "platforms/libqxcb.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QXcbIntegrationPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QXcbIntegrationPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QXcbIntegrationPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QXcbIntegrationPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QXcbIntegrationPlugin,${_no_plugins_genex}>>"
        ">"
...
set_property(TARGET Qt5::QXcbIntegrationPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::XcbQpa;Qt5::Gui;Qt5::Gui;Qt5::Core;Qt5::Core"
)
