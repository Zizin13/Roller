...
_qt5_SerialBus_process_prl_file(
    "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtpeakcanbus.prl" RELEASE
...
_populate_SerialBus_plugin_properties(PeakCanBusPlugin RELEASE "canbus/libqtpeakcanbus.a" FALSE)
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::PeakCanBusPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<NOT:$<IN_LIST:Qt::PeakCanBusPlugin,${_no_plugins_genex}>>"
        ">"
