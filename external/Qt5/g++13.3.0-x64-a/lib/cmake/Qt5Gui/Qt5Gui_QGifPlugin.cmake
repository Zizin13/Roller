...
set(_Qt5QGifPlugin_MODULE_DEPENDENCIES "Gui;Core")

foreach(_module_dep ${_Qt5QGifPlugin_MODULE_DEPENDENCIES})
...
_qt5_Gui_process_prl_file(
    "${_qt5Gui_install_prefix}/plugins/imageformats/libqgif.prl" RELEASE
    _Qt5QGifPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QGifPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QGifPlugin PROPERTY INTERFACE_SOURCES
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QGifPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QGifPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QGifPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QGifPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QGifPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QGifPlugin>"
)
...
set_property(TARGET Qt5::QGifPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Gui;Qt5::Core"
)
