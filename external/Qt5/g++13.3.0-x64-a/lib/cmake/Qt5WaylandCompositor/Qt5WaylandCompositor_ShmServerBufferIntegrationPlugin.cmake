...
set(_Qt5ShmServerBufferIntegrationPlugin_MODULE_DEPENDENCIES "WaylandCompositor;WaylandCompositor;Gui;Core")

foreach(_module_dep ${_Qt5ShmServerBufferIntegrationPlugin_MODULE_DEPENDENCIES})
...
_qt5_WaylandCompositor_process_prl_file(
    "${_qt5WaylandCompositor_install_prefix}/plugins/wayland-graphics-integration-server/libqt-wayland-compositor-shm-emulation-server.prl" RELEASE
    _Qt5ShmServerBufferIntegrationPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5ShmServerBufferIntegrationPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::ShmServerBufferIntegrationPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5WaylandCompositor_ShmServerBufferIntegrationPlugin_Import.cpp"
)

_populate_WaylandCompositor_plugin_properties(ShmServerBufferIntegrationPlugin RELEASE "wayland-graphics-integration-server/libqt-wayland-compositor-shm-emulation-server.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::ShmServerBufferIntegrationPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::ShmServerBufferIntegrationPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::ShmServerBufferIntegrationPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::ShmServerBufferIntegrationPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::ShmServerBufferIntegrationPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::ShmServerBufferIntegrationPlugin>"
)
set_property(TARGET Qt5::WaylandCompositor APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ${_plugin_genex}
)
set_property(TARGET Qt5::ShmServerBufferIntegrationPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
