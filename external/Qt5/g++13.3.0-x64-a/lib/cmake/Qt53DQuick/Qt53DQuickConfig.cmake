...
set(Qt53DQuick_VERSION_STRING 5.15.16)
        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt53DQuick_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.15.16"
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.15.16/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    _populate_3DQuick_target_properties(RELEASE "libQt53DQuick.a" "" FALSE)
