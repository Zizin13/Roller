...
set(_Qt5SocketCanBusPlugin_MODULE_DEPENDENCIES "SerialBus;Core")

foreach(_module_dep ${_Qt5SocketCanBusPlugin_MODULE_DEPENDENCIES})
...
_qt5_SerialBus_process_prl_file(
    "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtsocketcanbus.prl" RELEASE
    _Qt5SocketCanBusPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5SocketCanBusPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::SocketCanBusPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5SerialBus_SocketCanBusPlugin_Import.cpp"
)

_populate_SerialBus_plugin_properties(SocketCanBusPlugin RELEASE "canbus/libqtsocketcanbus.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::SocketCanBusPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::SocketCanBusPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::SocketCanBusPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::SocketCanBusPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::SocketCanBusPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::SocketCanBusPlugin>"
)
set_property(TARGET Qt5::SerialBus APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ${_plugin_genex}
)
set_property(TARGET Qt5::SocketCanBusPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
