...
_qt5_Qml_process_prl_file(
    "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_tcp.prl" RELEASE
    _Qt5QTcpServerConnectionFactory_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QTcpServerConnectionFactory_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QTcpServerConnectionFactory PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Qml_QTcpServerConnectionFactory_Import.cpp"
)

_populate_Qml_plugin_properties(QTcpServerConnectionFactory RELEASE "qmltooling/libqmldbg_tcp.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QTcpServerConnectionFactory,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QTcpServerConnectionFactory,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QTcpServerConnectionFactory,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QTcpServerConnectionFactory,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QTcpServerConnectionFactory,${_no_plugins_genex}>>"
        ">"
...
set_property(TARGET Qt5::QTcpServerConnectionFactory APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Qml;Qt5::Network"
)
