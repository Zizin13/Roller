...
set(Qt5Designer_VERSION_STRING 5.15.16)
...
function(_qt5_Designer_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5Designer_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5Designer_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5Designer_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
macro(_populate_Designer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt5Designer_STATIC_${Configuration}_LINK_FLAGS}")
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.15.16"
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.15.16/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Designer_process_prl_file(
            "${_qt5Designer_install_prefix}/lib/libQt5Designer.prl" RELEASE
    ...
    _populate_Designer_target_properties(RELEASE "libQt5Designer.a" "" FALSE)
