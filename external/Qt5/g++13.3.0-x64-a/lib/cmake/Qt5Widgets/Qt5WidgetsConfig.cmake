...
set(Qt5Widgets_VERSION_STRING 5.15.16)
...
function(_qt5_Widgets_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5Widgets_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5Widgets_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5Widgets_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_link_flags "${_Qt5Widgets_STATIC_${Configuration}_LINK_FLAGS}")
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/QtWidgets/5.15.16"
        "${_qt5Widgets_install_prefix}/include/QtWidgets/5.15.16/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Widgets_process_prl_file(
            "${_qt5Widgets_install_prefix}/lib/libQt5Widgets.prl" RELEASE
    ...
    set_property(TARGET Qt5::Widgets
                 ...
                 widgettextcontrol;effects;gtk3;style-fusion;style-windows)
    set_property(TARGET Qt5::Widgets
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 style-android;style-mac;style-windowsvista)
