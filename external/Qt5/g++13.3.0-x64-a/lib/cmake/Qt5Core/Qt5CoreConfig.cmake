...
set(Qt5Core_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/QtCore/5.15.16"
        "${_qt5Core_install_prefix}/include/QtCore/5.15.16/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;glib;glibc;posix-libiconv;hijricalendar;icu;inotify;linkat;mimetype-database;poll_ppoll;renameat2;sha3-fast;statx)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;gnu-libiconv;iconv;journald;lttng;poll_poll;poll_pollts;poll_select;system-pcre2;slog2;syslog;system-doubleconversion)
