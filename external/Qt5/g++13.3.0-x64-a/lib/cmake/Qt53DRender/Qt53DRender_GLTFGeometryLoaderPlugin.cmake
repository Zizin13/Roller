...
_populate_3DRender_plugin_properties(GLTFGeometryLoaderPlugin RELEASE "geometryloaders/libgltfgeometryloader.a" FALSE)
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::GLTFGeometryLoaderPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
string(CONCAT _plugin_genex
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<NOT:$<IN_LIST:Qt::GLTFGeometryLoaderPlugin,${_no_plugins_genex}>>"
        ">"
