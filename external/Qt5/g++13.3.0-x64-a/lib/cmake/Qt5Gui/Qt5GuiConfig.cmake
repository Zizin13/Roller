...
set(Qt5Gui_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.16"
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.16/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 xkbcommon;xkbcommon-x11;xcb;egl;eglfs;xlib;xcb-xlib;evdev;freetype;system-freetype;fontconfig;gif;ico;imageio-text-loading;jpeg;linuxfb;multiprocess;png;raster-64bit;tuiotouch;vkgen;vnc;xcb-glx-plugin;xcb-glx;xcb-sm)
    set_property(TARGET Qt5::Gui
